                ...
                <div class="width-container">
                    <article <?php post_class(array('singular','clearfix')); ?> id="post-<?php the_ID(); ?>">
                        <div class="post-meta">
                            <div class="flex">
                                <div class="time">
                                    <?php _e('Posted on', 'cuvita'); ?> <?php the_time('j. F, Y'); ?>
                                </div>
                                <?php the_author_posts_link(); ?>
                                <?php if (has_term('', 'category')) { ?>
                                    <div class="cats"><?php _e('Posted in', 'cuvita'); ?> <?php the_category(', '); ?></div>
                                <?php } ?>
                            </div>
                            <div class="flex">
                                ...
                                <?php } ?>
                                <?php if (has_term('', 'techs')) { ?>
                                    <div class="techs"><?php the_terms($post->ID, 'techs', '', ', '); ?></div>
                                <?php } ?>
                            </div>
                        </div>
                        <?php

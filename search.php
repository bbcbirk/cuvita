    ...
    <section class="banner">
        ...
        <div class="banner-content">
            ...
            if (@$cuvita_activate_portfolio == 1) {
                $project_text = __(' and Projects', 'cuvita');
            }
            echo '<h3 class="banner-tagline color__light_shade">'.__('Found ', 'cuvita').$wp_query->found_posts.__(' result(s) in Post, Pages', 'cuvita').$project_text.'</h3>';
            echo '<h1 class="banner-title color__light_shade">'.get_search_query().'</h1>';
            ?>
        </div>
    </section>
